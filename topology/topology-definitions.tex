...
\begin{definition}[Connected topological space, disjoint union definition]
...
\index{topological space!filtered}
\begin{definition}[Filtered topological space, filtered object]
...
\index{space!topological subspace}
\begin{definition}[Subspaces in topology, subobject definition]
